...
[Auto Close Tag](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-close-tag) 自动添加 HTML/XML 关闭标记，与 Visual Studio IDE 或 Sublime Text 相同。

[Auto Rename Tag](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-rename-tag) 自动重命名成对的 HTML/XML 标记，与 Visual Studio IDE 相同。
...
[CSS Peek](https://marketplace.visualstudio.com/items?itemName=pranaygp.vscode-css-peek) 支持在源代码中的字符串中找到css/scss/less(类和id) 我的class在哪定义的，自己都找不到了，怎么办，有请这位！！
